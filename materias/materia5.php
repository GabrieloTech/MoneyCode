...
<head>
    ...
    <title>Padrões Obscuros: como interfaces te induzem a gastar | MONEY CODE</title>
...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* CORREÇÃO DO BULMA: Garantir visibilidade e legibilidade das tags strong e a */
    strong {
    ...
    .topico-fomo ul, .materia-corpo ul { padding-left: 1.2rem; margin-top: 0.5rem; }
    .topico-fomo li, .materia-corpo li { margin-bottom: 0.75rem; }
...
<body>
    ...
    <!-- MATÉRIA COMPLETA DE PADRÕES OBSCUROS -->
    <main class="materia-container">

        <header class="materia-header">
            <span class="categoria">Consumo Digital</span>
            <h1>Padrões Obscuros: como interfaces te induzem a gastar</h1>
            <p class="subtitulo">Descubra os truques de design (Dark Patterns) utilizados por plataformas digitais para acelerar pagamentos e dificultar cancelamentos.</p>

            <div class="materia-meta">
                <span>Por Gustavo</span>
        ...
        <div class="imagem-principal-wrap">
            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1200&auto=format&fit=crop" alt="Pessoa analisando telas e interfaces no computador">
        </div>

        <article class="materia-corpo">
            <p>
                Você já assinou um serviço na internet com apenas um clique, mas precisou passar por um verdadeiro labirinto de páginas para conseguir cancelar? Ou talvez tenha comprado uma passagem aérea e só no checkout final percebeu que seguros e taxas extras foram inseridos no seu carrinho de forma invisível? Essas situações não ocorrem por acaso: são escolhas projetadas com intenção.
            </p>

            <div class="fomo-box-destaque">
                <p>"Dark Patterns utilizam a psicologia comportamental contra o usuário, transformando o design da plataforma em uma ferramenta de extração de receita."</p>
            </div>

            <h2>Como as interfaces exploram seus hábitos digitais</h2>
            <p>
                Conhecidos como <strong>Dark Patterns</strong> (ou Padrões Obscuros), esses métodos moldam a experiência do usuário para direcioná-lo a ações financeiras impensadas. As empresas usam vieses cognitivos comuns para manipular escolhas no ambiente virtual:
            </p>

            <div class="imagem-topico-wrap">
                <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=1000&auto=format&fit=crop" alt="Interface de aplicativo no celular exibindo opções de compra">
            </div>

            <div class="topico-fomo">
                <h3>1. Armadilhas de Assinatura e Custos Ocultos</h3>
                <ul>
                    <li><strong>Efeito "Roach Motel":</strong> A entrada no serviço é facilitada e exige poucos cliques, enquanto o cancelamento fica escondido sob telas secundárias, formulários burocráticos ou exige contato por canais de atendimento lentos.</li>
                    <li><strong>Adição Automática no Carrinho:</strong> Produtos adicionais — como garantias estendidas, doações e seguros — vêm pré-selecionados durante o fluxo de pagamento para exigir ação ativa do usuário ao desmarcá-los.</li>
                </ul>
            </div>

            <div class="topico-fomo">
                <h3>2. Pressão Psicológica e Manipulação Emocional</h3>
                <ul>
                    <li><strong>Alertas de Falsa Urgência:</strong> Avisos como <em>"Restam apenas 2 vagas nesse valor"</em> ou contadores regressivos forçam o comprador a acelerar o pagamento sem pesquisar opções equivalentes.</li>
                    <li><strong>Confirmshaming:</strong> Uso de frases com tom de culpa para botões de recusa, como <em>"Não, prefiro continuar sem economizar dinheiro"</em>, visando manipular a decisão do consumidor.</li>
                </ul>
            </div>

            <!-- IMAGEM RESTAURADA DA SEÇÃO -->
            <div class="imagem-topico-wrap">
                <img src="https://images.unsplash.com/photo-1556742111-a301076d9d18?q=80&w=1000&auto=format&fit=crop" alt="Pessoa realizando pagamento online com cartão">
            </div>

            <h2>Práticas para neutralizar armadilhas de UX</h2>
            <p>
                Manter o controle financeiro online exige atenção redobrada aos detalhes visuais das plataformas comercializadoras:
            </p>
            <ul>
                <li><strong>Revise o resumo final da compra:</strong> Confira todos os itens listados no extrato final antes de inserir a senha ou autorizar a transação.</li>
                <li><strong>Desconfie de botões em destaque:</strong> Elementos visuais muito chamativos costumam indicar as opções mais lucrativas para a plataforma, e não necessariamente a melhor escolha para o consumidor.</li>
                <li><strong>Avalie as regras de cancelamento previamente:</strong> Antes de assinar um serviço recorrente, verifique os termos da conta para garantir a possibilidade de encerramento rápido quando necessário.</li>
            </ul>

            <!-- FONTE E LINK DE REFERÊNCIA -->
            <div class="fonte-bloco">
                <strong>Fonte e Leitura Recomendada:</strong> 
                Para entender mais sobre como mapear e identificar padrões enganosos de interface, acesse o repositório global 
                <a href="https://www.deceptive.design" target="_blank" rel="noopener noreferrer">Deceptive Design (antigo Dark Patterns)</a>.
            </div>
        </article>
                ...
                <div class="carrossel-container" id="carrosselContainer">
                    <a href="materia1.php" class="card-veja-tambem">
                        <div class="thumb-wrapper">
                            <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=1200" alt="Síndrome de FOMO">
                        </div>
                    ...
                    <a href="materia3.php" class="card-veja-tambem">
                        <div class="thumb-wrapper">
                            <img src="https://images.pexels.com/photos/26922999/pexels-photo-26922999.jpeg" alt="Compras por impulso">
                        </div>
                    ...
                    <a href="materia4.php" class="card-veja-tambem">
                        <div class="thumb-wrapper">
                            <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?q=80&w=600" alt="Impacto dos algoritmos UX">
                        </div>
                    ...
                    <a href="materia2.php" class="card-veja-tambem">
                        <div class="thumb-wrapper">
                            <img src="https://plus.unsplash.com/premium_photo-1670863088251-500151f2117b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGNvbXByYXMlMjBhcGxpY2F0aXZvfGVufDB8fDB8fHww" alt="Segurança Digital e proteção bancária">
                        </div>
